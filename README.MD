...
Ambos os workflows também possuem o gatilho manual **`workflow_dispatch`**, permitindo rodar a esteira direto pela aba **Actions** do GitHub (botão **Run workflow**) mesmo sem novos commits.
